...
from algoritmia.datastructures.doubleendedpriorityqueues.intervalheap import MinMaxIntervalHeap, MaxMinIntervalHeap
...
class BfoWithOptimisticPruningSolver: #[bfo
    def __init__(self, opt=min, worst=infinity, 
            createOpenQueue=lambda space: MinMaxIntervalHeap(),
