...
from algoritmia.problems.shortestpaths.acyclic import ForwardDagShortestPathsFinder
...
back = ForwardDagShortestPathsFinder().some_to_some_backpointers(G, d, I, F)
backtracer = Backtracer(back)
