...
from algoritmia.problems.spanningtrees import KruskalsMinimumSpanningForestFinder
...
MST = list(KruskalsMinimumSpanningForestFinder().minimum_spanning_forest(G, d))
